...
feedback_tool = Tool(
    ...
    description="Use this tool to analyze and comment on customer feedback about restuarent."
)
...
def submit_feedback():
    ...
    with open(csv_file, mode="a", newline="", encoding="utf-8") as file:
        ...
        if file.tell() == 0:
            writer.writerow(["Timestamp", "Feedback", "Sentiment", "Agent Comment"])
        writer.writerow([timestamp, feedback, sentiment, agent_comment])
